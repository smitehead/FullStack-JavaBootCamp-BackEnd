...
public interface ProductService {
    ...
    Page<ProductListResponseDto> getProductList(int page, int size, Long large, Long medium, Long small,
                                                ...
                                                Boolean delivery, Boolean face, Boolean buyoutOnly, String sort, String keyword, Long memberNo);
    ...
    org.springframework.data.domain.Page<ProductListResponseDto> getMyBiddingProducts(Long memberNo, int page, int size, String filter);
